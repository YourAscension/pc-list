...
const ButtonIcon = (props) => {
	...
	if (props.icon === "add") {
		return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="25" height="25">
			<path d="M11 2L11 11L2 11L2 13L11 13L11 22L13 22L13 13L22 13L22 11L13 11L13 2Z"/>
		</svg>)
	}
}

const Button = (props) => {
	const {icon, type, tipTitle, title, onClick} = props;
	return (
		<button
			onClick={onClick}
			title={tipTitle}
